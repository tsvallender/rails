...
module ActiveRecord
  class DatabaseConfigurations
    ...
    class HashConfig < DatabaseConfig
      ...
      def schema_format(check_env: false)
        return ENV["SCHEMA_FORMAT"] if check_env && ENV["SCHEMA_FORMAT"].present?

        configuration_hash[:schema_format]&.to_sym || ActiveRecord.schema_format
      end
